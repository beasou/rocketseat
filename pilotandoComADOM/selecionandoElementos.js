/*
    ...
    getElementsByClassName() (retorno de dado HTMLCollection) -> NÃO conseguimos fazer um forEach
    getElementsByTagName(retorna um HTMLCollection)
    querySelector(RETORNA ELEMENTO)
    querySelectorAll (retorno de dado Nodelist) -> conseguimos fazer um forEach
*/
/*
//getElementById()
